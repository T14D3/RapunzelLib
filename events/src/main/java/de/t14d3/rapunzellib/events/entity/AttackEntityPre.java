...
public final class AttackEntityPre extends BaseCancellablePreEvent {
    ...
    public AttackEntityPre(RPlayer player, RWorldRef world, RBlockPos pos, String entityTypeKey) {
        this(player, world, pos, entityTypeKey, false);
    }

    public AttackEntityPre(RPlayer player, RWorldRef world, RBlockPos pos, String entityTypeKey, boolean isCancelled) {
