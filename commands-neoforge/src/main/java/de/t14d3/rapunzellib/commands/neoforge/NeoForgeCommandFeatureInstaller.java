...
public final class NeoForgeCommandFeatureInstaller implements CommandFeatureInstaller {
    @Override
    ...
    public void install(@NotNull RapunzelContext context) {
        CommandSourceAdapter adapter = CommandFeatureInstallerSupport.commandSourceAdapter(
            ...
            NeoForgeCommandSourceAdapter::wrap
        );
        ...
        context.register(
            ...
            new NeoForgeSharedBrigadierCommandRegistrar(commandService, adapters)
        );
