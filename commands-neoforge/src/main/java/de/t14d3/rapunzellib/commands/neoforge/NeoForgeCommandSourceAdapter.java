...
final class NeoForgeCommandSourceAdapter {
    ...
    static @NotNull RCommandSource wrap(@NotNull CommandSourceStack source) {
        ...
        return AudienceCommandSourceAdapterCore.wrap(
            PlatformId.NEOFORGE,
            source,
            NeoForgeCommandSourceAdapter::audience,
            NeoForgeCommandSourceAdapter::hasPermission,
            NeoForgeCommandSourceAdapter::player
        );
    }

    private static @NotNull Audience audience(@NotNull CommandSourceStack source) {
        ServerPlayer player = nativePlayer(source);
        return player != null ? (Audience) player : new NeoForgeCommandSourceAudience(source);
    }
    ...
    private static final class NeoForgeCommandSourceAudience implements Audience {
        private final CommandSourceStack source;

        private NeoForgeCommandSourceAudience(@NotNull CommandSourceStack source) {
