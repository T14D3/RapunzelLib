...
public final class YamlMessageFormatService implements MessageFormatService {
     ...
     * @return the formatted component, or a fallback component containing the key text if not found
     */
    @Override
     ...
     *
     * @param key          the message key to look up
     * @param placeholders the placeholders to substitute into the template
