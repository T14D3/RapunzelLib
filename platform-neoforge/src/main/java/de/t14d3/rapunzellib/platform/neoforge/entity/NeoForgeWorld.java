...
final class NeoForgeWorld extends SharedWorldBase {
    NeoForgeWorld(ServerLevel world, NeoForgeWorlds worlds) {
        super(PlatformId.NEOFORGE, Objects.requireNonNull(world, "world"), de.t14d3.rapunzellib.attachments.RAttachmentContainer.lazyMutable(), Objects.requireNonNull(worlds, "worlds"));
    }
