...
public final class NeoForgeEntities extends SharedEntitiesCore<SharedEntityBase> {
    ...
    public NeoForgeEntities(@NotNull MinecraftServer server, @NotNull NeoForgePlayers players, @NotNull NeoForgeWorlds worlds) {
    ...
    protected @NotNull SharedEntityBase createEntity(@NotNull Entity entity) {
        if (entity instanceof LivingEntity livingEntity) {
            return new NeoForgeLivingEntity(livingEntity, worlds);
        }
        return new NeoForgeEntity(entity, worlds);
    }
