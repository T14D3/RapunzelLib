...
public final class SpongeModuleConventionsPlugin implements Plugin<Project> {
    ...
    public void apply(Project target) {
        ...
        ConventionPluginSupport.addLibraryDependency(target, "compileOnly", "sponge-api");
        ConventionPluginSupport.addLibraryDependency(target, "testImplementation", "sponge-api");
    }
}
