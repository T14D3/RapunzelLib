...
public final class VelocityModuleConventionsPlugin implements Plugin<Project> {
    ...
    public void apply(Project target) {
        ...
        BuildLogicPluginSupport.addLibraryDependency(target, "compileOnly", "velocity-api");
        BuildLogicPluginSupport.addLibraryDependency(target, "annotationProcessor", "velocity-api");
        BuildLogicPluginSupport.addLibraryDependency(target, "testImplementation", "velocity-api");
    }
}
